...
const SettingsRow = ({
  ...
  return (
    <TouchableOpacity
      style={[s.settingsRow, !last && s.settingsRowBorder]}
      onPress={onPress}
      activeOpacity={0.7}
        ...
        <View style={s.section}>
          ...
          <View style={s.settingsGroup}>
            <SettingsRow
              ...
              subtitle="Hide profile from discovery"
              right={
                <Switch
                  value={incognito}
                  onValueChange={toggleIncognito}
                  trackColor={{ true: colors.blue, false: colors.mist }}
                />
              }
              last
            />
...
const makeStyles = (colors) =>
  StyleSheet.create({
    ...
    menuDivider: { height: 1, backgroundColor: colors.mist },
