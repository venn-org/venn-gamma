...
const ACTION_CODE_SETTINGS = {
  ...
  // Deep-link config for native: allows Firebase to hand email-link sign-in back to the app.
  // These must match the dynamic links config in Firebase console.
  iOS: {
    bundleId: 'com.venn.app',
  },
  android: {
    packageName: 'com.venn.app',
    installApp: true,
    minimumVersion: '1',
  },
};
