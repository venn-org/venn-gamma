...
export const lightColors = {
  ...
  // Chrome. The header is a step off canvas rather than a bold fill — enough
  // to read as its own panel without shouting over the page.
  header: '#E9EBF2',
  headerText: '#14161B',
  tabBar: '#fff',
  tabBarBorder: '#E6E8EE',
...
export const darkColors = {
  ...
  // A step off canvas the other direction — lighter than the page so the
  // panel still reads as distinct on a dark background.
  header: '#1B1E26',
  headerText: '#F2F3F7',
  tabBar: '#1C1F27',
  tabBarBorder: '#2A2E3A',
